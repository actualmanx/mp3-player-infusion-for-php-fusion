...
$backcolor=preg_match("/^[0-9A-F]{6}$/i", $_POST['backcolor'])?$_POST['backcolor']:$mp3settings['backcolor']; //for extra security - ekstra g�venlik i�in
$frontcolor=preg_match("/^[0-9A-F]{6}$/i", $_POST['frontcolor'])?$_POST['frontcolor']:$mp3settings['frontcolor']; //for extra security - ekstra g�venlik i�in
$lightcolor=preg_match("/^[0-9A-F]{6}$/i", $_POST['lightcolor'])?$_POST['lightcolor']:$mp3settings['lightcolor']; //for extra security - ekstra g�venlik i�in
